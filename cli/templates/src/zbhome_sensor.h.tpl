...
GENERATE_ATTR_VAL_SETTER(co2, CARBON_DIOXIDE)
...
GENERATE_ATTR_SENSOR_VALUE_SETTER(co2, float, float, ZCL_CARBON_DIOXIDE_MEASURED_VALUE_MULTIPLIER)
...
GENERATE_SENSOR_FULL_FOR_ATTR(co2, SENSOR_CHAN_CO2)